...
public class KafkaTopicConfig {
    ...
    public NewTopic authorUpdatedTopic() {
        return TopicBuilder.name(authorUpdatedTopicName)
                .partitions(1)
                .replicas(1)
                .build();
    }
    ...
    public NewTopic authorDeletedTopic() {
        return TopicBuilder.name(authorDeletedTopicName)
                .partitions(1)
                .replicas(1)
                .build();
    }
    ...
    public NewTopic documentUpdatedTopic() {
        return TopicBuilder.name(documentUpdatedTopicName)
                .partitions(1)
                .replicas(1)
                .build();
    }
    ...
    public NewTopic documentDeletedTopic() {
        return TopicBuilder.name(documentDeletedTopicName)
                .partitions(1)
                .replicas(1)
                .build();
    }
