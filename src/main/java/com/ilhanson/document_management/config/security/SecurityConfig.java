        ...
        .authorizeHttpRequests(
            requestMatcherRegistry ->
                requestMatcherRegistry
                    ...
                    .permitAll()
                    .requestMatchers(GET, "/api/v1/authors")
                    .hasAnyRole(READER.name(), EDITOR.name())
                    .requestMatchers(GET, "/api/v1/authors/**")
                    .hasAnyRole(READER.name(), EDITOR.name())
                    .requestMatchers(GET, "/api/v1/documents")
                    .hasAnyRole(READER.name(), EDITOR.name())
                    .requestMatchers(GET, "/api/v1/documents/**")
                    .hasAnyRole(READER.name(), EDITOR.name())
                    .requestMatchers(POST, "/api/v1/authors")
                    .hasRole(EDITOR.name())
                    .requestMatchers(POST, "/api/v1/authors/**")
                    .hasRole(EDITOR.name())
                    .requestMatchers(PUT, "/api/v1/authors/**")
                    .hasRole(EDITOR.name())
                    .requestMatchers(DELETE, "/api/v1/authors/**")
                    .hasRole(EDITOR.name())
                    .requestMatchers(POST, "/api/v1/documents")
                    .hasRole(EDITOR.name())
                    .requestMatchers(POST, "/api/v1/documents/**")
                    .hasRole(EDITOR.name())
                    .requestMatchers(PUT, "/api/v1/documents/**")
                    .hasRole(EDITOR.name())
                    .requestMatchers(DELETE, "/api/v1/documents/**")
                    .hasRole(EDITOR.name())
                    .anyRequest()
                    .authenticated())
