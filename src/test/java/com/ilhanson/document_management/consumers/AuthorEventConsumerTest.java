...
class AuthorEventConsumerTest {
    ...
    @InjectMocks
    private AuthorEventConsumer authorEventConsumer;

    @Test
    void shouldHandleAuthorUpdatedEventAndCallRelevantServices() throws JsonProcessingException {
        // Arrange
        String event = "{\"id\":1,\"firstName\":\"John\",\"lastName\":\"Doe\",\"documents\":[{\"id\":1,\"title\":\"Doc 1\",\"body\":\"Body 1\"},{\"id\":2,\"title\":\"Doc 2\",\"body\":\"Body 2\"}]}";

        AuthorDetailsDTO authorDetailsDTO = new AuthorDetailsDTO(1L, "John", "Doe", List.of(
                new DocumentDTO(1L, "Doc 1", "Body 1"),
                new DocumentDTO(2L, "Doc 2", "Body 2")
        ));
    ...
    void shouldLogErrorIfDocumentDeletionFails() throws JsonProcessingException {
        // Arrange
        String event = "{\"id\":1,\"firstName\":\"John\",\"lastName\":\"Doe\",\"documents\":[{\"id\":1,\"title\":\"Doc 1\",\"body\":\"Body 1\"}]}";
        ...
        doThrow(new RuntimeException("Failed to delete document")).when(documentService).deleteDocument(1L);
