...
class DocumentTest {
    ...
    void testAddReference() {
        Document document = new Document(1L, "Doc Title", "Doc", new HashSet<>(), new HashSet<>(), new HashSet<>());
        Document reference = new Document(2L, "Ref Title", "Ref", new HashSet<>(), new HashSet<>(), new HashSet<>());
    ...
    void testEqualsAndHashCode() {
        Document document1 = new Document(1L, "Doc Title", "Doc", new HashSet<>(), new HashSet<>(), new HashSet<>());
        Document document2 = new Document(1L, "Ref Title", "Ref", new HashSet<>(), new HashSet<>(), new HashSet<>());
