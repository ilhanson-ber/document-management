...
class AuthenticationControllerTest {
  ...
  void shouldHandleBadCredentialsExceptionOnLogin() throws Exception {
    ...
    // Simulate the service throwing a BadCredentialsException when incorrect credentials are
    // provided
  ...
  void shouldReturnBadRequestForInvalidSignupDTO() throws Exception {
    // Arrange
    SignupDTO invalidSignupDTO =
        SignupDTO.builder().firstName("").lastName("").username("").password("").role(null).build();
  ...
  void shouldHandleDuplicateKeyExceptionOnSignup() throws Exception {
    ...
    when(authenticationService.signup(any(SignupDTO.class)))
        .thenThrow(new DuplicateKeyException("username", "samiral"));
