...
class AuthorControllerTest {
  ...
  void shouldGetAllAuthors() throws Exception {
    ...
    // Act & Assert
    mockMvc
        .perform(get("/api/v1/authors").with(csrf()))
  ...
  void shouldCreateAuthorWithDocuments() throws Exception {
    ...
    AuthorCreateDTO authorCreateDTO =
        new AuthorCreateDTO(null, "John", "Doe", List.of(document1, document2));
  ...
  void shouldReturnBadRequestForInvalidAuthorCreateDTO() throws Exception {
    // Arrange
    AuthorCreateDTO invalidAuthorCreateDTO =
        new AuthorCreateDTO(null, "", "", null); // Invalid data
  ...
  void shouldHandleResourceNotFoundException() throws Exception {
    // Arrange
    when(authorService.createAuthor(any(AuthorCreateDTO.class)))
