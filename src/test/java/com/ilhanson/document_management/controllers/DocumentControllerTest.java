...
class DocumentControllerTest {
  ...
  void shouldGetAllDocuments() throws Exception {
    ...
    // Act & Assert
    mockMvc
        .perform(get("/api/v1/documents").with(csrf()))
  ...
  void shouldCreateDocument() throws Exception {
    ...
    when(documentService.createDocument(any(DocumentCreateDTO.class)))
  ...
  void shouldReturnBadRequestForInvalidDocumentCreateDTO() throws Exception {
    // Arrange
    DocumentCreateDTO invalidDocumentCreateDTO =
        new DocumentCreateDTO(null, "", "", null, null); // Invalid data
  ...
  void shouldCreateDocumentWithAuthorsAndReferences() throws Exception {
    ...
    DocumentCreateDTO documentCreateDTO =
        new DocumentCreateDTO(
            null, "Doc 1", "Body 1", List.of(reference1, reference2), List.of(author1, author2));
