...
class KafkaIntegrationTest {
    ...
    public void kafkaIntegrationTest() throws InterruptedException {
        ...
        AuthorDetailsDTO author = webTestClient.get()
        ...
        AuthorUpdateDTO updatedAuthor = new AuthorUpdateDTO(author.getId(), author.getFirstName(), author.getLastName(), List.of(new IdInputDTO(4L)));
        webTestClient.put()
