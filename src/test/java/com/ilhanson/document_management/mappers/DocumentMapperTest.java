...
class DocumentMapperTest {
    ...
    void shouldMapDocumentCreateDTOToDocumentWithEmptyAssociations() {
        DocumentCreateDTO documentCreateDTO = new DocumentCreateDTO(null, "Doc Title", "Doc Body", new ArrayList<>(), new ArrayList<>());
    ...
    void shouldMapDocumentCreateDTOToDocument() {
        ...
        DocumentCreateDTO documentCreateDTO = new DocumentCreateDTO(null, "Doc Title", "Doc Body", references, authors);
    ...
    void shouldMapDocumentUpdateDTOToDocument() {
        List<IdInputDTO> authors = List.of(new IdInputDTO(1L), new IdInputDTO(2L));
        List<IdInputDTO> references = List.of(new IdInputDTO(1L), new IdInputDTO(2L));
        DocumentUpdateDTO documentUpdateDTO = new DocumentUpdateDTO(1L, "Doc Title", "Doc Body", references, authors);
