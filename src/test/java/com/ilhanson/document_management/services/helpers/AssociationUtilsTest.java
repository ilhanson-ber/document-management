...
class AssociationUtilsTest {
  ...
  void shouldAddAndRemoveDocumentsFromAuthor() {
    Set<Document> documentsFromClient =
        Set.of(
            new Document(1L, "Doc 1", "Body 1", new HashSet<>(), new HashSet<>(), new HashSet<>()),
            new Document(2L, "Doc 2", "Body 2", new HashSet<>(), new HashSet<>(), new HashSet<>()));
    List<Document> documentsFromRepo =
        List.of(
            new Document(1L, "Doc 1", "Body 1", new HashSet<>(), new HashSet<>(), new HashSet<>()),
            new Document(2L, "Doc 2", "Body 2", new HashSet<>(), new HashSet<>(), new HashSet<>()));
    Set<Document> documentsFromAuthor =
        Set.of(
            new Document(1L, "Doc 1", "Body 1", new HashSet<>(), new HashSet<>(), new HashSet<>()),
            new Document(3L, "Doc 3", "Body 3", new HashSet<>(), new HashSet<>(), new HashSet<>()));
    ...
    BiConsumer<Author, Document> addDocumentToAuthor =
        spy(
            new BiConsumer<>() {
              @Override
    ...
    BiConsumer<Author, Document> removeDocumentFromAuthor =
        spy(
            new BiConsumer<>() {
              @Override
              public void accept(Author auth, Document doc) {
    ...
    verify(addDocumentToAuthor, times(1))
        .accept(
            author,
            new Document(2L, "Doc 2", "Body 2", new HashSet<>(), new HashSet<>(), new HashSet<>()));
    verify(removeDocumentFromAuthor, times(1))
        .accept(
            author,
            new Document(3L, "Doc 3", "Body 3", new HashSet<>(), new HashSet<>(), new HashSet<>()));
