...
public class AuthorRepositoryTest {
  ...
  void shouldCreateNewAuthor() {
    Author author =
        Author.builder().firstName("Alice").lastName("Brown").documents(new HashSet<>()).build();
  ...
  void shouldNotCreateAuthorWithEmptyFirstName() {
    Author author =
        Author.builder().firstName("").lastName("Brown").documents(new HashSet<>()).build();
  ...
  void shouldNotCreateAuthorWithEmptyLastName() {
    Author author =
        Author.builder().firstName("Alice").lastName("").documents(new HashSet<>()).build();
